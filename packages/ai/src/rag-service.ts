...
import type { ExtractionProgressCallback } from "./ocr-service";
...
export class RAGService {
    ...
    try {
      ...
      switch (mimeType) {
        case "application/pdf":
          return await this.ocrService.extractPDF(buffer, onProgress, signal);
  ...
  /**
   * Extract text from image files with OCR. Delegates to the OCR service.
   */
  async extractTextFromImage(
    ...
    return this.ocrService.extractTextFromImage(buffer, mimeType, signal);
  }
