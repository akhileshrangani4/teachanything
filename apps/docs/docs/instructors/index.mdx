...
<Steps>
  ...
  <Step title="Add your materials">
    [Upload files](/instructors/upload-materials) or
    [point it at a website](/instructors/add-website-content). The assistant
    reads and remembers everything.
  </Step>
...
<Steps>
  <Step title="Sign up">
    [Create an account](https://teachanything.ai/register) with your name,
    email address, and a password. Some deployments only let certain email
    domains (like your school's) register, so use your institutional email if
    you have one.
  </Step>
...
<Card title="Create your first chatbot" href="/instructors/create-a-chatbot" icon="plus">
