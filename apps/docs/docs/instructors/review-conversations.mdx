...
<Steps>
  ...
  <Step title="Check answer quality">
    Skim answers to make sure the tone and accuracy match what you want. If they
    don't, adjust the
    [instructions](/instructors/customize#the-instructions-field).
  </Step>
</Steps>
...
<Card
  title="Next: Export chat records"
  href="/instructors/export-chat-records"
  icon="download"
>
  Download conversations — with quiz results — as a web page, spreadsheet, or
  plain text.
</Card>
